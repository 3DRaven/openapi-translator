...
function visitGenericParametersStart(namesStack, parameters, extensions, callsStack)
    return {}
end

return functionCallAndLog("visitGenericParametersStart", visitGenericParametersStart)
