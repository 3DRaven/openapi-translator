...
--- This visitor is invoked at the start of OpenAPI scpec for every described server
...
function visitSpecServer(url, description, variables, extensions)
    return {}
end

return functionCallAndLog("visitSpecServer", visitSpecServer)
