...
local function visitStringProperty(stringDescriptor, extensions, callsStack)
    return CODEGEN.addGenericPropertyCode(GLOBAL_CONTEXT.models:peek(), CODE.getStringType(), extensions)
end
