...
local function visitSecurityRequirementsEnd(securities, extensions, callsStack)
    return {}
end

return functionCallAndLog("visitSecurityRequirementsEnd", visitSecurityRequirementsStart)
